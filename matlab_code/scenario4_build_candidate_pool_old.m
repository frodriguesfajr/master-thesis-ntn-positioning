...
outDir = "results_scenario5_candidate_pool";
...
fprintf('\n============================================================\n');
fprintf('SCENARIO 5 - CONJUNTO CANDIDATO FINAL\n');
...
writetable(Tpool,fullfile(outDir,'scenario5_candidate_pool_26.csv'));
writetable(Tsummary,fullfile(outDir,'scenario5_geometry_summary.csv'));

if ~isempty(Tredundant)
    writetable(Tredundant,fullfile(outDir,'scenario5_redundant_pairs.csv'));
end

save(fullfile(outDir,'scenario5_candidate_pool_26.mat'), ...
    'analysisTimeUTC', ...
